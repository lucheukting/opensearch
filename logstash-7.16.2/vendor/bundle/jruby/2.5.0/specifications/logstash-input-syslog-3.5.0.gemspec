# -*- encoding: utf-8 -*-
# stub: logstash-input-syslog 3.5.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<logstash-filter-grok>.freeze, [">= 4.4.0"])
    ...
    s.add_dependency(%q<logstash-filter-grok>.freeze, [">= 4.4.0"])
