# -*- encoding: utf-8 -*-
# stub: logstash-output-elasticsearch 11.2.3 java lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<manticore>.freeze, [">= 0.7.1", "< 1.0.0"])
    ...
    s.add_dependency(%q<manticore>.freeze, [">= 0.7.1", "< 1.0.0"])
